...
\begin{tabular}{l|l|l|l}
   & Exclude these from Step 2 &             &          \\
FD & when computing closure     & Closure     & Decision \\
\hline
1 & 1 & $B^+ = \{A,B,D\}$. $C \notin B^+$. & keep \\
2 & 2 & $C^+ = \{A,B,C\}$. $A \in C^+$. & \textbf{discard} \\
3 & 2, 3 & $C^+ = \{C\}$. $B \notin C^+$. & keep \\
4 & 2, 4 & $C^+ = \{B,C,D\}$. $D \in C^+$. & \textbf{discard} \\
5 & 2, 4, 5 & $(CF)^+ = \{B,C,E,F\}$. $E \in (CF)^+$. & \textbf{discard} \\
6 & 2, 4, 5, 6 & $E^+ = \{E\}$. $B \notin E^+$. & keep \\
